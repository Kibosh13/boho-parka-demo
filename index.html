  ...
  <main id="content">
    ...
    <section class="process section section-dark" id="process" aria-labelledby="process-title">
      ...
      <ul class="process-list">
        <li><h3>Готовая верхняя парка</h3><p>Стандартная парка из плащевой ткани, сшитая по лекалам бренда.</p></li><li><h3>Разбор изделия на детали</h3><p>Работа по перекрою мехового изделия.</p></li><li><h3>Ремонт и удаление дефектов</h3><p>Затёртостей, плешин и заломов.</p></li><li><h3>Сортировка материала</h3><p>По цвету и качеству ворса.</p></li><li><h3>Сборка материала</h3><p>По новым лекалам для подстёжки в парку.</p></li><li><h3>Правка и чистка</h3><p>Увлажнение и растяжка скроя с применением специальных составов. Биочистка в барабане с опилками.</p></li>
      </ul>
      <div class="native-gallery native-gallery-process" data-gallery-prefix="process-spec" data-gallery-count="15" data-gallery-alt="Этап работы с мехом в мастерской"></div>
    </section>

    <section class="why-continuation section" aria-labelledby="why-continuation-title">
    ...
    <section class="price section section-burgundy" aria-labelledby="price-title"><div class="price-copy"><p class="eyebrow">14 — Понятная цена</p><h2 id="price-title">Полная стоимость работы<br><em>с курткой — 78 000 ₽</em></h2></div><div class="price-action"><span class="price-number">78</span><span class="price-unit">тысяч рублей</span></div></section>
    ...
    <section class="reference-links section section-dark" aria-labelledby="reference-title">
      ...
      <div class="reference-grid">
        <article><a href="https://bohoparka.com/o-brende/" target="_blank" rel="noopener">Интересные факты об истории нашей мастерской и её создательнице</a><button class="image-button" type="button" data-lightbox="assets/images/reference-founder.jpg"><img src="assets/images/reference-founder.jpg" alt="Наталья Неклюдова в мастерской" loading="lazy"></button></article>
        <article><a href="https://bohoparka.com/o-brende/istoriya-proishozhdeniya/" target="_blank" rel="noopener">История стиля БОХО</a><button class="image-button" type="button" data-lightbox="assets/images/reference-boho.jpg"><img src="assets/images/reference-boho.jpg" alt="Образ в стиле бохо" loading="lazy"></button></article>
        <article><a href="https://bohoparka.com/product-category/woman/" target="_blank" rel="noopener">Легендарные парки M52</a><button class="image-button" type="button" data-lightbox="assets/images/reference-m52.jpg"><img src="assets/images/reference-m52.jpg" alt="Парка M52" loading="lazy"></button></article>
      </div>
    </section>
